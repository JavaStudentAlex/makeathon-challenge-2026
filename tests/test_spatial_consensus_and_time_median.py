...
from stats_models import spatial_consensus_and_time_median as model
...
def _zero_non_forest_features(shape: tuple[int, int] = (4, 4)) -> dict[str, np.ndarray]:
    features = {
...
def test_run_experiment_uses_time_step_consensus_and_year_projection() -> None:
